...
internal class BookingService : IBookingService
{
    ...
    public async Task InitializeFlights()
    {
        ...
        new Flight("IR303", "MHD", "BND", DateTime.Now.AddDays(1).AddHours(1), DateTime.Now.AddDays(1).AddHours(3), 85, 890_000),
    ...
    {
        return _flights.FindAll(f => f.DepartureAirport == departureAirport &&
                                f.DestinationAirport == destinationAirport && f.DepartureTime == date).ToList();
    }
}
